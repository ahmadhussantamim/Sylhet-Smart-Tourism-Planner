...
Save every image below into this folder: `frontend/src/assets/images/`
...
5. Move it into `frontend/src/assets/images/`.
6. The code already imports images using paths like
   `/src/assets/images/hero-banner.jpg` - no code changes needed once
